...
class UploadExistingHandler(TornadoRequestHandlerBase):
        ...
        if self.multipart_streamer:
            try:
                ...
                cur.execute(
                    ...
                    '(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)',
                    [log_id, title, description, log_id,
